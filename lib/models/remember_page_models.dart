...
class RememberPageModel extends ChangeNotifier {
  /// The private field backing [favoritelist].
  late LearnPageModel _favoritelist;
  ...
  LearnPageModel get favoritelist => _favoritelist;

  set favoritelist(LearnPageModel newList) {
